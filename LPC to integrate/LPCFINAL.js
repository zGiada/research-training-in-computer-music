...
// Formanti maschili per I, é, È, A, O, ó, U
// I valori a margine (primo e ultimo) sono inesistenti: servono solo per agevolare il calcolo dei range nell'algoritmo ??????

// uomo
// var form1 = [100,  280,  360,  560,  800,  520, 420, 280, 100];
// var form2 = [2460, 2240, 2040, 1840, 1280, 900, 800, 720, 600];
...
function compare(valid) {
	if (valid.length == 0) {
		...
		if (valid[2] != null) {
			let i;
			for (i = 1; i <= 7; i++) {
				let max = form2[1 - 1] - ((form2[i - 1] - form2[i]) / 2);
