...
const SimpleSvgComponent = ({ svgColor, rad, yCoordinate }) => {
    const c_y = 50;
    const shadowRadius = rad+15; // Adjust the shadow radius as needed
        ...
        <View style={{ aspectRatio: 1 }}>
            <Svg height="100%" width="100%" viewBox="0 0 100 100">                
                ...
                <Circle
                    ...
                    strokeWidth={0}
                />
                <Circle r={rad} cx="50" cy={yCoordinate} fill={svgColor} />                
            </Svg>
        </View>
    );
};
